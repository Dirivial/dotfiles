...
theme.colors.fg0 = "#CDD6F4"
theme.colors.fg1 = "#CDD6F4"
theme.colors.fg2 = "#CDD6F4"
theme.colors.fg3 = "#CDD6F4"
theme.colors.fg4 = "#CDD6F4"

theme.colors.yellow   = "#d79921"
theme.colors.yellow_h = "#fabd2f"

theme.colors.orange   = "#EBA0AC"
theme.colors.orange_h = "#E64553"
...
function theme.at_screen_connect(s)
  ...
  -- Create the wibox
  s.mywibox = awful.wibar({ position = "bottom", screen = s, height = dpi(24), bg = theme.colors.bg_normal,
    fg = theme.fg_normal, border_color = theme.colors.bg0, border_width = dpi(3) })
